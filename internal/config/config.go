...
type Config struct {
	...
	// CustomProvider defines external providers whose upstream request protocol can be selected
	// independently for each provider entry.
	CustomProvider []CustomProvider `yaml:"custom-provider" json:"custom-provider"`
